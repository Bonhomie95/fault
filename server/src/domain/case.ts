...
const CONFESSION = [
  ...
  /\bi('m| am) guilty\b/i,
  /\bi confess\b/i,
  /\b(never|didn'?t|did not) mean(t)? (for it |to|any harm|harm|anyone harm)\b/i,
  // Motive offered as mitigation is an admission of the act: "I was desperate",
  // "I had no choice", "I only did it for my family".
  /\bi was (so |just )?desperate\b/i,
  /\bi had no (other )?choice\b/i,
  /\bi (only |just )?did (it|this|that|what i did) (for|because)\b/i,
  /\bforgive me\b/i,
