 ...
 *
 * Orun City is fictional. No real legal system is depicted.
 */
export const SEED_CASES: GeneratedCase[] = [
  {
    title: 'The State v. Adaeze Nwosu',
    charge: 'Theft of property exceeding ₦2,000,000',
    accent: 'financial',
    defendant: {
      name: 'Adaeze Nwosu',
      age: 34,
      occupation: 'Night-shift inventory clerk, Orun Central Depot',
      background:
    ...
    evidence: [
      {
        id: 'e1',
        description: 'Depot ledger showing 14 crates signed out under Nwosu’s code at 02:40.',
      ...
      {
        id: 'e2',
        description: 'Bank record: ₦400,000 deposited to Nwosu’s account three days after the theft.',
    ...
    character_pool_additions: [
      { name: 'Adaeze Nwosu', role: 'defendant', themes: ['theft', 'labour', 'class'] },
      { name: 'Tunde Balogun', role: 'witness', themes: ['theft', 'security'] },
      { name: 'Ifeoma Chukwu', role: 'witness', themes: ['theft', 'labour'] },
    ],
  },
  {
    title: 'The State v. Emeka Obi',
    charge: 'Aggravated assault',
    accent: 'violent',
    defendant: {
      name: 'Emeka Obi',
      age: 27,
      occupation: 'Danfo driver, Ojuelegba route',
      background:
    ...
    evidence: [
      ...
      {
        id: 'e2',
        description: 'Phone video, 9 seconds, beginning after the blow, showing Obi standing over the complainant.',
      ...
      {
        id: 'e3',
        description: 'Obi’s message to the complainant, sent the previous night: "Settle this tomorrow or I will."',
    ...
    character_pool_additions: [
      { name: 'Emeka Obi', role: 'defendant', themes: ['violence', 'debt', 'class'] },
      { name: 'Blessing Adeyi', role: 'witness', themes: ['violence', 'market'] },
      { name: 'Musa Danjuma', role: 'witness', themes: ['violence', 'police'] },
    ],
  },
  {
    title: 'The State v. Victor Adeyemi',
    charge: 'Aggravated fraud',
    accent: 'financial',
    defendant: {
      name: 'Victor Adeyemi',
      age: 41,
      occupation: 'Director, Adeyemi Housing Trust',
      background:
    ...
    evidence: [
      {
        id: 'e1',
        description: '₦180m transferred from the deposit account to Kestrel Works Ltd over nine months.',
        prosecution_reading: 'Kestrel is a shell he controls. The money went in a circle back to him.',
        defence_reading:
          'Kestrel built the first four hundred units. Paying your builder is not fraud — it is the job.',
        is_planted: false,
      },
      {
        id: 'e2',
        description: 'Adeyemi’s handwritten note: "If Kestrel folds, the depositors are exposed. Say nothing yet."',
      ...
      {
        id: 'e3',
        description: 'No personal enrichment found: Adeyemi’s accounts, home, and vehicles are unchanged since 2019.',
    ...
    defence_argument:
      'He built four hundred homes. The contractor collapsed with the currency. He is not enriched by a single naira. This is a ruined builder, and the State has confused catastrophe with intent.',
    correct_verdict: 'ambiguous',
    evidence_strength: 0.2,
    character_pool_additions: [
      { name: 'Victor Adeyemi', role: 'defendant', themes: ['fraud', 'housing', 'class', 'systemic'] },
      { name: 'Chinelo Eze', role: 'witness', themes: ['fraud', 'housing'] },
      { name: 'Bashir Lawal', role: 'witness', themes: ['fraud', 'construction'] },
    ],
  },
  {
    title: 'The State v. Amara Okafor',
    charge: 'Possession of a controlled substance with intent to supply',
    accent: 'systemic',
    defendant: {
      name: 'Amara Okafor',
      age: 23,
      occupation: 'Pharmacy student, University of Orun',
      background:
    ...
    evidence: [
      ...
      {
        id: 'e3',
        description: 'Okafor’s pharmacology coursework, including a paper on tramadol dependency in Orun State.',
    ...
    character_pool_additions: [
      { name: 'Amara Okafor', role: 'defendant', themes: ['drugs', 'police', 'systemic'] },
      { name: 'Kelechi Umeh', role: 'witness', themes: ['police', 'systemic'] },
      { name: 'Ngozi Umeh', role: 'witness', themes: ['academic', 'police'] },
    ],
  },
  {
    title: 'The State v. Folake Adebayo',
    charge: 'Arson',
    accent: 'passion',
    defendant: {
      name: 'Folake Adebayo',
      age: 38,
      occupation: 'Owner, Adebayo Fabrics, Balogun Market',
      background:
    ...
    evidence: [
      ...
      {
        id: 'e3',
        description: 'Adebayo’s phone was at her mother’s house in Ikeja, 19km away, from 20:00 until after the alarm.',
    ...
    character_pool_additions: [
      { name: 'Folake Adebayo', role: 'defendant', themes: ['arson', 'family', 'market'] },
      { name: 'Yemi Adebayo', role: 'witness', themes: ['arson', 'family'] },
      { name: 'Sikirat Bello', role: 'witness', themes: ['arson', 'market'] },
    ],
  },
  {
    title: 'The State v. Ibrahim Sule',
    ...
    evidence: [
      {
        id: 'e1',
        description: 'Bank transfer of ₦300,000 from Sule’s company to the official’s personal account.',
      ...
      {
        id: 'e2',
        description: 'Depot records showing Sule’s trucks held 19 days without a stated reason.',
        prosecution_reading: 'Administrative delay. Every haulier waits; only Sule paid to stop waiting.',
        defence_reading:
      ...
      {
        id: 'e3',
        description: 'Recording of the official: "Ibrahim understands how things move here. Others learn slower."',
        prosecution_reading: 'Sule is a known payer. He understands because he has done this before.',
    ...
    prosecution_argument:
      'He paid a public official ₦300,000 to move his trucks. He admits it. This is the transaction that rots a road authority, and the books show it was not his first.',
    defence_argument:
    ...
    character_pool_additions: [
      { name: 'Ibrahim Sule', role: 'defendant', themes: ['corruption', 'systemic', 'labour'] },
      { name: 'Hauwa Sule', role: 'witness', themes: ['corruption', 'family'] },
      { name: 'Obiora Nnamdi', role: 'witness', themes: ['corruption', 'systemic'] },
    ],
  },
];
